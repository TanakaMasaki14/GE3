...
void ReDirectX::InitializeCommand() {
	// コマンドアロケータを生成
...
void ReDirectX::InitializeSwapChain() {
	// スワップチェーンの設定
...
void ReDirectX::InitializeDepthBuff() {
